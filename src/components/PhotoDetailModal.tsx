              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 h-full">
                ...
                <div className="lg:col-span-7 bg-surface-container-low flex flex-col justify-center items-center border-b lg:border-b-0 lg:border-r border-outline-variant/30 min-h-[280px] sm:min-h-[350px] lg:min-h-[500px] p-6 relative">
                  ...
                  <div className="absolute top-4 left-4 z-10 flex flex-wrap gap-1.5 pointer-events-none">
                    <span className={`text-[9px] font-extrabold px-2.5 py-1 rounded-full shadow-sm text-white flex items-center gap-1 uppercase tracking-wider ${
                      photo.isPrivate ? 'bg-error/85' : 'bg-tertiary/85'
                    }`}>
                      {photo.isPrivate ? (
                        <>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-1.5">
                          <input
                            ...
                            className="flex-grow px-3 py-2 bg-surface rounded-xl border border-outline-variant text-[11px] font-mono select-all truncate text-primary font-semibold"
                          />
                          <button
